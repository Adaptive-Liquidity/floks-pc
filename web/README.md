...
- Look: Stitch product UI on live routes — deep space `#0a0a0a`, neon lime `#c3f400`, glass modules, Space Grotesk / Geist / JetBrains Mono. Not a second app, not a dumped mock folder.
