...
- **Compute plane**: one VM (or later microVM) per Node. Filesystem, processes, browser, and the private display live only there. Grok remains the intelligence; Runloop is not the agent runtime.
